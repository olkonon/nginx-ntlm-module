...
cd $DIR/buildnginx
./configure --with-debug --with-cc-opt='-g -O2 -fstack-protector-strong -Wformat -Werror=format-security' --with-pcre --with-http_ssl_module --add-module=./modules/nginx-ntlm-module/
make -j12
